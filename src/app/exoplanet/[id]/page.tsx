...
export default function ExoplanetProfilePage() {
  ...
  const downloadPdf = async () => {
    ...
    try {
      ...
      doc.setFontSize(12)
      doc.setFont('helvetica', 'bold')
      doc.text(locale === 'en' ? 'Exoscope - Advanced Analysis System' : 'Exoscope - Systeme d Analyse Avance', 
        margin, yPosition + 5)
            ...
            <div id="pdf-content" className="bg-white p-8 rounded-lg border">
              ...
              <div className="header">
                ...
                <p className="text-gray-600 mt-2">
                  {locale === 'en' ? 'Generated by Exoscope' : 'Généré par Exoscope'} - {new Date().toLocaleDateString(locale === 'en' ? 'en-US' : 'fr-FR')}
                </p>
              </div>
              ...
              <div className="footer">
                <p>
                  {locale === 'en' 
                    ? 'This report was generated by Exoscope - Advanced Exoplanet Classification System'
                    : 'Ce rapport a été généré par Exoscope - Système Avancé de Classification d\'Exoplanètes'
                  }
                </p>
                <p className="mt-2">
                  {locale === 'en' ? 'For more information, visit' : 'Pour plus d\'informations, visitez'} exoscope.com
                </p>
              </div>
            </div>
